...
apigClientFactory.newClient = function (config) {
    ...
    if(config === undefined) {
        config = {
            ...
            sessionToken: '',
            region: '',
            apiKey: '2M0snczng872P1tMS7koy9fHyLfr8U8F6qI7i5hO',
    ...
    var invokeUrl = 'https://nqoglqcqtk.execute-api.us-east-1.amazonaws.com/v1';
    ...
    apigClient.uploadBucketKeyPut = function (params, body, additionalParams) {
        console.log("in apigClient.uploadBucketKeyPut");
